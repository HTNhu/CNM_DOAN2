...
function Payment(props) {
    ...
    // }
    const serviceIds = props.getServices.getAllService
    return (
        <>
            ...
            <div style={{ margin: '50px 50px' }}>
                ...
                <Row type="flex" justify="center" align="top">
                    <Col span={6} onClick={() => {
                        ...
                        history.push(`/payment/${serviceIds[0].id}`)
                    }}>
                    ...
                    <Col span={6} onClick={() => {
                        history.push(`/payment/${serviceIds[1].id}`)
                    }} >
                        <Card style={{ width: '200px' }}>
                            <Card.Meta
                    ...
                    <Col span={6} onClick={() => {
                        history.push(`/payment/${serviceIds[2].id}`)
                    }}
                    >
                        <Card style={{ width: '200px' }}>
                            <Card.Meta
